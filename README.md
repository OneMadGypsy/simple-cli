...
If you are using a mounted drive with a Raspberry Pi Pico maybe you would be interested in my [pico-sd-card](https://github.com/OneMadGypsy/pico-sd-card) module. This cli app was 100% written because of my SD card module.
